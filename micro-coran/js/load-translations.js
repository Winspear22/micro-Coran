...
function render(data, trad, showPhonetic = true, showArabic = true, showFrench = true, reciter = "al-alafasy") {
  ...
  for (let i = 1; i <= 7; i++) {
    ...
    if (showNothing) {
      ...
      verset.innerHTML = `
        ...
        <audio controls>
          <source src="../audio/${reciter}/parts/al-fatiha/00100${i - 1}.mp3" type="audio/mpeg">
        </audio>
      `;
    }
  ...
  if (fullAudio) {
    fullAudio.src = `../audio/${reciter}/complete/al-fatiha/001.mp3`;
